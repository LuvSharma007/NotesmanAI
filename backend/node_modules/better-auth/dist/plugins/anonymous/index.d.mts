...
declare const anonymous: (options?: AnonymousOptions | undefined) => {
  id: "anonymous";
  endpoints: {
    signInAnonymous: better_call249.StrictEndpoint<"/sign-in/anonymous", {
      method: "POST";
      metadata: {
        openapi: {
          description: string;
    ...
    deleteAnonymousUser: better_call249.StrictEndpoint<"/delete-anonymous-user", {
      method: "POST";
      use: ((inputContext: better_call249.MiddlewareInputContext<better_call249.MiddlewareOptions>) => Promise<{
        session: {
  ...
  hooks: {
    after: {
      matcher(ctx: _better_auth_core18.HookEndpointContext): boolean;
      handler: (inputContext: better_call249.MiddlewareInputContext<better_call249.MiddlewareOptions>) => Promise<void>;
    }[];
  };
