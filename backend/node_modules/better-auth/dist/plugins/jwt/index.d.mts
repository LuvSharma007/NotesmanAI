...
import * as better_call157 from "better-call";
...
declare const jwt: <O extends JwtOptions>(options?: O) => {
  ...
  options: NoInfer<O>;
  endpoints: {
    getJwks: better_call157.StrictEndpoint<string, {
      method: "GET";
      metadata: {
        openapi: {
          operationId: string;
    ...
    getToken: better_call157.StrictEndpoint<"/token", {
      method: "GET";
      requireHeaders: true;
      use: ((inputContext: better_call157.MiddlewareInputContext<better_call157.MiddlewareOptions>) => Promise<{
        session: {
    ...
    signJWT: better_call157.StrictEndpoint<string, {
      method: "POST";
      metadata: {
        $Infer: {
          body: {
    ...
    verifyJWT: better_call157.StrictEndpoint<string, {
      method: "POST";
      metadata: {
        $Infer: {
          body: {
  ...
  hooks: {
    after: {
      ...
      handler: (inputContext: better_call157.MiddlewareInputContext<better_call157.MiddlewareOptions>) => Promise<void>;
    }[];
  };
  schema: {
    jwks: {
