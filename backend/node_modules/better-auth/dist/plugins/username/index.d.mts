...
import * as better_call206 from "better-call";
...
declare const username: (options?: UsernameOptions | undefined) => {
      ...
      databaseHooks: {
        user: {
          create: {
            ...
            } & Record<string, unknown>, context: _better_auth_core7.GenericEndpointContext | null): Promise<{
              data: {
  ...
  endpoints: {
    signInUsername: better_call206.StrictEndpoint<"/sign-in/username", {
      method: "POST";
      body: z.ZodObject<{
    ...
    isUsernameAvailable: better_call206.StrictEndpoint<"/is-username-available", {
      method: "POST";
      body: z.ZodObject<{
        username: z.ZodString;
      }, z.core.$strip>;
  ...
  hooks: {
    before: {
      ...
      handler: (inputContext: better_call206.MiddlewareInputContext<better_call206.MiddlewareOptions>) => Promise<void>;
    }[];
  };
