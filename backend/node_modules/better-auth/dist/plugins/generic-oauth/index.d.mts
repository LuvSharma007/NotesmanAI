...
import * as better_call152 from "better-call";
...
declare const genericOAuth: (options: GenericOAuthOptions) => {
  ...
  endpoints: {
    signInWithOAuth2: better_call152.StrictEndpoint<"/sign-in/oauth2", {
      method: "POST";
      body: zod441.ZodObject<{
        providerId: zod441.ZodString;
        callbackURL: zod441.ZodOptional<zod441.ZodString>;
        errorCallbackURL: zod441.ZodOptional<zod441.ZodString>;
        newUserCallbackURL: zod441.ZodOptional<zod441.ZodString>;
        disableRedirect: zod441.ZodOptional<zod441.ZodBoolean>;
        scopes: zod441.ZodOptional<zod441.ZodArray<zod441.ZodString>>;
        requestSignUp: zod441.ZodOptional<zod441.ZodBoolean>;
        additionalData: zod441.ZodOptional<zod441.ZodRecord<zod441.ZodString, zod441.ZodAny>>;
      }, zod_v4_core61.$strip>;
      metadata: {
        openapi: {
          description: string;
    ...
    oAuth2Callback: better_call152.StrictEndpoint<"/oauth2/callback/:providerId", {
      method: "GET";
      query: zod441.ZodObject<{
        code: zod441.ZodOptional<zod441.ZodString>;
        error: zod441.ZodOptional<zod441.ZodString>;
        error_description: zod441.ZodOptional<zod441.ZodString>;
        state: zod441.ZodOptional<zod441.ZodString>;
      }, zod_v4_core61.$strip>;
      metadata: {
    ...
    oAuth2LinkAccount: better_call152.StrictEndpoint<"/oauth2/link", {
      method: "POST";
      body: zod441.ZodObject<{
        providerId: zod441.ZodString;
        callbackURL: zod441.ZodString;
        scopes: zod441.ZodOptional<zod441.ZodArray<zod441.ZodString>>;
        errorCallbackURL: zod441.ZodOptional<zod441.ZodString>;
      }, zod_v4_core61.$strip>;
      use: ((inputContext: better_call152.MiddlewareInputContext<better_call152.MiddlewareOptions>) => Promise<{
        session: {
