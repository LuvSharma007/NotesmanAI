...
declare const oidcProvider: (options: OIDCOptions) => {
  ...
  readonly options: {
    ...
    getAdditionalUserInfoClaim?: ((user: _better_auth_core_db3.User & Record<string, any>, scopes: string[], client: Client) => Record<string, any> | Promise<Record<string, any>>) | undefined;
