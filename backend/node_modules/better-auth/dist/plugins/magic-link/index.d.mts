...
declare const magicLink: (options: MagicLinkOptions) => {
  ...
  endpoints: {
     ...
     */
    signInMagicLink: better_call165.StrictEndpoint<"/sign-in/magic-link", {
      method: "POST";
      requireHeaders: true;
      body: z.ZodObject<{
        email: z.ZodEmail;
     ...
     */
    magicLinkVerify: better_call165.StrictEndpoint<"/magic-link/verify", {
      method: "GET";
      query: z.ZodObject<{
        token: z.ZodString;
        callbackURL: z.ZodOptional<z.ZodString>;
      ...
      use: ((inputContext: better_call165.MiddlewareInputContext<better_call165.MiddlewareOptions>) => Promise<void>)[];
      requireHeaders: true;
      metadata: {
        openapi: {
          operationId: string;
