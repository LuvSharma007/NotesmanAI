        ...
        <section className="py-12 md:py-20 font-sans">
            <div className="mx-auto max-w-5xl space-y-8 px-6 md:space-y-16">
                <div className="relative z-10 mx-auto max-w-xl space-y-6 text-center md:space-y-12">
                    <h2 className="text-balance text-4xl font-medium lg:text-5xl">Features of Notesman</h2>
                    <p>Notesman is evolving to be more than just the AI Agent. It going to supports an Almost every types of Digital Source.</p>
                </div>
